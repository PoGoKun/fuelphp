<?php echo Form::open(array("class"=>"form-horizontal")); ?>
    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <?php echo Form::textarea('descripcion', Input::post('descripcion', isset($producto) ? $producto->descripcion : ''), array('class' => 'col-md-4 form-control', 'rows' => 8, 'placeholder'=>'Descripcion')); ?>
        </div>
        <div class="form-group">
